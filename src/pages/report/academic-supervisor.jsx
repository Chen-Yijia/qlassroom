...
import { Table, Grid, Accordion, Header, Icon } from "semantic-ui-react";
import Nav from "../../components/shared/Nav";
import SubNav from "./SubNav";
import ModalAcademic from "./component/academic-modal";

import "../shared/layout.css";
// import _ from 'lodash'

class AcademicSupervisorReportPage extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  ...
  render() {
    ...
    function AcademicModals(props) {
      const students = props.students;
      const modals = students.map((student) => <ModalAcademic student={student.name} reports={student.reports} />)
      return (modals)
    }
              ...
              <Accordion>
                ...
                <Accordion.Content active={activeIndex === 0}>
                  <Table selectable unstackable>
                    ...
                    <Table.Body>
                      {/* <ModalAcademic student='Anthony' /> */}
                      <AcademicModals students={students} />
                      {/* <Table.Row>
...
export default AcademicSupervisorReportPage;
