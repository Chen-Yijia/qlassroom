...
class CriteriaThree extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            ...
            <Segment>
                ...
                <p style={{ marginTop: "48px", fontSize: "15px" }}>
                    IT delivery service-level agreement ratings may be used to evaluate the responsibilities of each party in the implementation of the IEA system. These include ratings on meeting the milestones of project management and escalation procedures, cost/service tradeoffs, reporting processes and dispute resolution processes.  Client satisfaction rates that evaluate whether expectations were met and client retention rates would be useful feedback.  Document your results.
                </p>
