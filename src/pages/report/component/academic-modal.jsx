...
import ModalAcademicComment from "./academic-comment";
import ModalStudent from "./academic-student";

function ReportModals(props) {
    const reports = props.reports;
    const modals = reports.map((report) => <ModalAcademicComment report={report} />)
    return (modals)
}

function ModalAcademic(props) {
